...
function ftle_time_hist_PairedTif(directory, imnames, ftleLRC, r_scale, t_scale, firstframe, lastframe)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% INPUTS %%%
...
param.time_bin = floor(60/t_scale); % Bin each hour
...
% All vectors
figure(1)
savename = [directory 'FTLE Analytics\' imname '_hist_time_total'];
...
% Edge vectors only
figure(2)
savename = [directory 'FTLE Analytics\' imname '_hist_time_edge'];
...
% Center vectors only
figure(3)
savename = [directory 'FTLE Analytics\' imname '_hist_time_center'];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% Save Outputs %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save([directory 'FTLE Analytics\' imname '_FTLE_edge.mat'],'ftles'...
