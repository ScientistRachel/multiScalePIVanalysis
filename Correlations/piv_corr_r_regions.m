...
function piv_corr_r_regions(directory, imname, r_scale, t_scale, firstframe, lastframe,pos_list,overwrite)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% INPUTS %%%
...
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r(speed_now,x_now,y_now,t_scale,r_scale,0,lastframe,max_dist,savedir,'Autocorrelation of speed')
end

savedir = [directory 'Correlation Data\' imname '_speed_no_mean_radial_corr_edge'];
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r(speed_now,x_now,y_now,t_scale,r_scale,1,lastframe,max_dist,savedir,'Autocorrelation of speed - mean')
end

savedir = [directory 'Correlation Data\' imname '_vr_radial_corr_edge'];
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r(v_r_now,x_now,y_now,t_scale,r_scale,0,lastframe,max_dist,savedir,'Autocorrelation of v_r')
end

savedir = [directory 'Correlation Data\' imname '_vr_no_mean_radial_corr_edge'];
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r(v_r_now,x_now,y_now,t_scale,r_scale,1,lastframe,max_dist,savedir,'Autocorrelation of v_r - mean')
end

savedir = [directory 'Correlation Data\' imname '_vth_radial_corr_edge'];
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r(v_th_now,x_now,y_now,t_scale,r_scale,0,lastframe,max_dist,savedir,'Autocorrelation of v_\theta')
end

savedir = [directory 'Correlation Data\' imname '_vector_radial_corr_edge'];
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r_vector(u_now,v_now,x_now,y_now,t_scale,r_scale,0,lastframe,max_dist,savedir,'Autocorrelation of Velocity')
end

savedir = [directory 'Correlation Data\' imname '_vector_no_mean_radial_corr_edge'];
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r_vector(u_now,v_now,x_now,y_now,t_scale,r_scale,1,lastframe,max_dist,savedir,'Autocorrelation of Velocity - Mean')
end
...
if ~exist([savedir '.mat'],'file') || overwrite
correlatePIV_r(speed_now,x_now,y_now,t_scale,r_scale,1,lastframe,max_dist,savedir,'Autocorrelation of speed')
end
