...
function piv_corr_r_variability(directory, imname, r_scale, t_scale, firstframe, lastframe,pos_list)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% INPUTS %%%
...
% figure(2)
savedir = [directory 'Correlation Data\' imname '_vr_radial_corr_var'];
% correlatePIV_r_NaNnorm(v_r,x,y,t_scale,r_scale,0,lastframe,max_dist,savedir,'Autocorrelation of v_r')
correlatePIV_r_variability(v_r,x,y,t_scale,0,lastframe,max_dist,savedir,'Autocorrelation of v_r')
