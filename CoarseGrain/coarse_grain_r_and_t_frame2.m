function [l_c, t_c, pR, pT] = coarse_grain_r_and_t_frame2(directory,imname,final_frame_user,r_scale,t_scale)
...
[u,v,x,y,a,final_frame] = set_up_edge_piv(directory, imname,final_frame_user,edge_cut,r_scale,t_scale);
