function [l_c, t_c, pR, pT] = coarse_grain_MultiC_sqrt(directory,imname,final_frame_user,r_scale,t_scale)
...
savename = [directory 'Coarse Test\' imname '_r fit each frame'];
...
%     t_c = pT(1);
    ...
    savename = [directory 'Coarse Test\' imname '_t fit each frame'];
    saveas(gcf,[savename '.tif'],'tif')
    saveas(gcf,[savename '.fig'],'fig')
...
%%%%% Save relevant data
save([directory 'Coarse Test\' imname '_coarse_data.mat'],'imname','directory',...
