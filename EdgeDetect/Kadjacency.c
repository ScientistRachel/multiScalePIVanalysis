...
mex -f mexopts_intel10amd.bat -output Kadjacency.dll Kadjacency.c
 ...
 *
 *Change Log
 *2019/08/26 RML changed mexErrMsgTxt to mexErrMsgTxt (running in MATLAB 2019a)
