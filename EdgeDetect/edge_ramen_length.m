function edge_ramen_length(directory,imname,edgedat,timestep, diststep, saveimpose,firstframe,lastframe,colormap,high,low)
...
if ~exist('color_map','var') || isempty(colormap)
...
if strcmp(edgedat.side, 'right')
    big = max(edgedat.points(:));
elseif strcmp(edgedat.side, 'left')
