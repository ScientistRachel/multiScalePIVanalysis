...
function [x_all,y_all,u,v,r_scaled,beginning, ending] = do_scale_shift_MultiC(u,v,x,y,x_pos,y_pos,X,Y,R,r_scale,t_scale)
...
% 2019/08/29 RML - no longer displays valid frames, still outputs them
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%% Adjust coordinates
