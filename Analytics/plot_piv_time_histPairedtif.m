...
function plot_piv_time_histPairedtif(directory, imnames, r_scale, t_scale, firstframe, lastframe,pos_list)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% INPUTS %%%
...
% Speed
savename = [directory 'PIV Hist\' imname '_speed_edge_hist'];
figure(1)
...
% Angles
savename = [directory 'PIV Hist\' imname '_angle_edge_hist'];
figure(2)
% Take histogram and normalize
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% Save Outputs %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save([directory 'PIV Hist\' imname '_PIV_edge.mat'],'speed','angles'...
