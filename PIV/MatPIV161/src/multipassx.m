...
%
% CHANGE LOG: RML 2012/03/22 - Commented out compatability for rgb images,
%             RML 2013/04/10 - Commented out progress displays
...
for i=1:iter-1
    %disp(['* Pass No: ',num2str(i)])  %%% RML 2013/04
    ...
    if i~=iter-1 
        ...
        %disp('   Expanding velocity-field for next pass') %%% RML 2013/04
