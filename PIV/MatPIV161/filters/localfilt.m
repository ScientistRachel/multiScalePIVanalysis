...
%
% % CHANGE LOG: 2013/04/10 RML Commented out display
...
% fprintf([' Local ',stat,' filter running: ']) % CHANGE LOG: 2013/04/10 RML Commented out display
...
%         histo(jj,ii)=u1+i*v1;
    ...
    %fprintf('.') % CHANGE LOG: 2013/04/10 RML Commented out display
...
%fprintf([num2str(rest),' vectors changed']) % CHANGE LOG: 2013/04/10 RML Commented out display
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
